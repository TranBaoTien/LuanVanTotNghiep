...
import { getAlluser,createNewUser ,
    editupdateUser,
    getAlltypeuser} from '../../../services/userService.js';
    import { getAllNhanvien,createNhanvien ,deleteUser} from '../../../services/adminnhanvienService';
...
class UserManage extends Component {
   ...
   async componentDidMount() {
        let response=await getAllNhanvien();
        let arrtype=await getAlltypeuser();
        if(response){
            this.setState({
                arrUsers:response,
                arrType:arrtype
...
createUser=async(data)=>{
  try {
    let response=await createNhanvien(data);
    if(response)
    {
        this.setState({
